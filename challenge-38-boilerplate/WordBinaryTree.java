...
public class WordBinaryTree {
        ...
        public Node insert(Node node,Word data)//inserting the values to tree through recursion
        {
            if(node == null)
            {
                node = new Node(data);
        ...
        public int size(Node node)//getting size of the tree
        {
            if(node!=null){
    ...
    public Word[] occurance(Node node,int count)// this method its getting the occurence of the word and seting with respective word
    {
        ...
        //**the below method is to delete the similar items */
        ...
        //**this below method is to insert the values in to tree from object array */
        ...
        public void printTree(Node node,Direction direction)//printing the values in tree with how many times it repeated
        {
            if(direction.equals(Direction.PREORDER))
            {
                if(node!=null)
                {
                    ...
                    printTree(node.left,Direction.PREORDER);
                    printTree(node.right,Direction.PREORDER);
                }
            }
        }
    }
